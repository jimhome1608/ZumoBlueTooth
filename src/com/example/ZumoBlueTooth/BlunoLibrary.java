...
import com.example.ZumoBlueTooth.R;
...
public abstract  class BlunoLibrary  extends Activity{
    ...
    static int TIME_RUNNABLE = 60000;
...
//	}
	...
	private int mBaudrate=38400;	//set the default baud rate to 115200
	private String mPassword="AT+PASSWOR=1234\r\n";
...
//	byte[] mBaudrateBuffer={0x32,0x00,(byte) (mBaudrate & 0xFF),(byte) ((mBaudrate>>8) & 0xFF),(byte) ((mBaudrate>>16) & 0xFF),0x00};;
			...
			public void onClick(DialogInterface dialog, int which)
			{
		        ...
		        if(mDeviceName.equals("No Device Available") && mDeviceAddress.equals("No Address Available"))
		        {
		        	...
		        	if (mBluetoothLeService.connect(mDeviceAddress)) {
			        	...
			        	onConectionStateChange(mConnectionState);
			            mHandler.postDelayed(mConnectingOverTimeRunnable, TIME_RUNNABLE);
		        	}
			        else {
    ...
    public void onPauseProcess() {
		...
		if(mBluetoothLeService!=null)
		{
            ...
            mHandler.postDelayed(mDisonnectingOverTimeRunnable, TIME_RUNNABLE);
